    ...
    <div class="container-fluid">
      ...
      <?= $projectname ?>
        ...
        <ul class="nav">
              ...
              <li class="<?= ($whereiam == 'Customeracceptance')?'active':NULL; ?>"><a href="<?= base_url() ?>Customeracceptance/" class="tipping" data-placement="bottom" title="Customeracceptance">Customeracceptance</a></li>
